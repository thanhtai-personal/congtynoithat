...
class Carousel extends Component {
  ...
  render () {
    ...
    return (
      <div id={this.props.id} className={`${classes.root} ${this.props.className ? this.props.className : ''}`} onMouseEnter={this.stop} onMouseOut={this.reset}>
        {
...
function CarouselItem (props) {
  ...
  return (
    props.display ? (
      <div {...swipeHandlers} className={props.className || ''} >
